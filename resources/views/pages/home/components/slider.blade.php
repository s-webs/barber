<div class="py-[40px] lg:py-0 h-[500px] lg:h-[840px] flex items-center justify-center relative">
    <div class="w-full h-full absolute left-0 top-0 z-[3]">
        <img src="/assets/images/image-02.jpg" alt="slide 01" class="w-full h-full object-cover">
    </div>
    <div class="bg-gray-900 opacity-[70%] w-full h-full absolute z-[4]"></div>
    <div class="container relative z-[5]">
        <div class="text-center">
            <h1 class="text-[var(--color-main)] font-semibold text-2xl lg:text-[64px]">
                Барбершоп для настоящих мужчин
            </h1>
            <h2 class="text-[var(--color-halftone)] font-semibold text-md lg:text-[28px]">
