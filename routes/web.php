...
Route::get('/booking/success', [\App\Http\Controllers\Public\BookingController::class, 'success'])->name('booking.success');
...
Route::prefix('/api')->group(function () {
    ...
    Route::get('/barbers/by-service', [\App\Http\Controllers\Public\BookingController::class, 'barbersByService']);
    ...
    Route::post('/appointments/store', [\App\Http\Controllers\Public\BookingController::class, 'createAppointment']);
});
